...
export default function Project(projectData: dataType) {
    ...
    return (
        ...
        >
            <section
                className="bg-gray-100 max-w-[40rem] border border-black/5 min-h-[24rem] 
                rounded-lg overflow-hidden sm:pr-8 relative sm:h-[24rem] hover:bg-gray-200 
            ...
            >
                <div className="h-full">
                    ...
                    flex flex-col justify-around h-full sm:group-even:ml-[18rem]"
                    >
                        <div>
                        ...
                        <Image
                            ...
                            width={400}
                            height={400}
                            className="block sm:hidden py-3 rounded-md
                                transition 
